...
export const socialLinks: SocialLink[] = [
  { label: 'GitHub', href: 'https://github.com/gulsahntoppo', icon: 'github' },
  { label: 'Twitter', href: 'https://twitter.com/gulsahntoppo', icon: 'twitter' },
  { label: 'LinkedIn', href: 'https://linkedin.com/in/gulsahntoppo', icon: 'linkedin' },
  { label: 'Email', href: 'mailto:toppo.gulshan@gmail.com', icon: 'mail' },
];
